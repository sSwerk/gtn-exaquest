...
$string['request_questions_label'] = 'Click this button to request new questions from ';
$string['request_questions_button'] = 'Request';
$string['revise_questions_label'] = 'The following questions are open for revision: ';
